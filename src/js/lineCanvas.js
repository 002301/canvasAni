...
class lineCanvas {
  constructor(dom,bool=true) {
    ...
    this.height = this.canvas.height = cssHeight;
    // mouse infomation.
    this.mouseX = null;
    this.mouseY = null;
    this.mouseZ = null;
  ...
  resize() {
    this.shapes_array = [];
    this.width = this.canvas.width = this._dom.width;
    this.height = this.canvas.height = this._dom.height;
    this.init();
  }
}
